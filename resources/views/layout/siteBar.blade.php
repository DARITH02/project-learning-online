        ...
        <div class="flex items-center space-x-3 pl-2">
            <a href="{{route('/')}}" class="w-full flex items-center">
                <div class="w-15 h-15 bg-gradient-to-br  rounded-lg flex items-center justify-center">
                    <img class="w-full h-full" src="{{asset('storage/logo/logo.png')}}" alt="">
        ...
        <div class="rounded-lg">
            ...
            <div class="w-full">
                ...
                <div class="submenu max-h-0 overflow-hidden transition-all duration-300 ">
                    <div class="submenu-item px-6 py-2 text-sm hover:bg-gray-200 cursor-pointer relative"
                        ...
                        <a href="{{route('viewCourses')}}" class="w-full flex {{request()->routeIs('viewCourses') ? 'text-blue-400 font-bold' : ''}}" >
                            Courses List</div>
                        </a>
                    <div class="submenu-item px-6 py-2 text-sm font-medium  hover:bg-blue-100 cursor-pointer relative"
                        onclick="setActive(this)">
                          <a href="{{route('viewcategory')}}" class="w-full flex {{request()->routeIs('viewcategory') ? 'text-blue-400 font-bold' : ''}}" >
                            Categories List
                        </a>
                       </div>
                    <div class="submenu-item px-6 py-2 text-sm font-medium  hover:bg-blue-100 cursor-pointer relative"
                        onclick="setActive(this))">
                           ...
                           <a href="{{route('lessionCreate')}}" class="w-full flex {{request()->routeIs('lessionCreate') ? 'text-blue-400 font-bold' : ''}}" >
                           Lession
                        </a>
                    ...
                    <div class="submenu-item px-6 py-2 text-sm font-medium  hover:bg-blue-100 cursor-pointer relative"
                        onclick="setActive(this)">
                           ...
                           <a href="{{route('create-module')}}" class="w-full flex {{request()->routeIs('create-module') ? 'text-blue-400 font-bold' : ''}}" >
                          Modules
                        </a>
            ...
            <div class="w-full">
                ...
                <div class="submenu max-h-0 overflow-hidden transition-all duration-300">
                    ...
                    onclick="setActive(this);">
                    <a href="{{route('users.index')}}" class="flex w-full {{request()->routeIs('users.index')? 'text-blue-400 font-bold' : ''}}">
                        Users List
                    </a>
                   </div>
                      <div class="submenu-item px-6 py-2 text-sm hover:bg-gray-200 cursor-pointer"
                    onclick="setActive(this);">
                    <a href="{{route('get-users-purchases.index')}}" class="flex w-full {{request()->routeIs('get-users-purchases.index')? 'text-blue-400 font-bold' : ''}}">
                        User purchases
                    </a>
                   </div>
                    <div class="submenu-item px-6 py-2 text-sm hover:bg-gray-200 cursor-pointer"
