        ...
        <div class="bg-mode rounded-xl shadow p-6">
            <form action="" id="frm-lession" data-url="{{route('create-lession.store')}} ">
                ...
                <div class="w-full">
                    ...
                    <select name="course" id="course" class="px-3 py-2.5 border-2 border-gray-200 rounded-md mt-2.5">
        ...
        <div class="rounded-xl shadow p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="flex gap-2">
                    <button type="button" onclick="uploadMultipleImages('#frm-lession','#course')"
                        class="px-4 py-2 bg-blue-600 rounded-md text-sm hover:bg-blue-700 cursor-pointer">
                        Upload All
                    </button>
                    <button onclick="clearFrmVideos('#frm-lession','#course')" class="cursor-pointer px-4 py-2 border border-gray-300 rounded-md text-sm hover:bg-gray-50">
                        Clear All
                    </button>
                </div>
            </div>
