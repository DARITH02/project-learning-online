  ...
  <div class="w-full p-8">
    ...
    <form id="form-update-crategory" class="space-y-6" data-url="{{ route('updateCategory.update') }}">
      ...
      <div class="w-3/12">
        ...
        <input type="text" id="ttlel_up" name="title" value="{{$category->title}}" placeholder="Enter Title"
      ...
      <div class="w-3/4">
        ...
        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 placeholder-gray-400">{{$category->description}}</textarea>
      ...
      <!-- Create Button -->
      <div class="pt-4">
      <button onclick="udpateCate('#form-update-crategory')" type="button"
